    ...
    return (
        <div className="page">
            ...
            <div className="page-section">
                ...
                <br></br>
                <a href="https://github.com/Viterbo" target="_blank" rel="noopener noreferrer"><TypewriterText ticking={true} hover={true} orange={true} speed={10}>/Viterbo Rodriguez </TypewriterText></a>
                <a href="https://github.com/poplexity" target="_blank" rel="noopener noreferrer"><TypewriterText ticking={true} hover={true} orange={true} speed={10}>/Jesse Schulman </TypewriterText></a>
