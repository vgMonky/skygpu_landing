    ...
    return (
        <div className="page">
            ...
            <div className="page-section">
                ...
                <p className='x'><TypewriterText speed={10}>Old proof of concept:</TypewriterText></p>
                ...
                <br></br>
                <p className='x'><TypewriterText speed={10}>Current software suite:</TypewriterText></p>
                ...
                <br></br>
                <p className='x'><TypewriterText speed={10}>Hyperion plugin for extra metadata indexing and serving:</TypewriterText></p>
                ...
                <br></br>
                <p className='x'><TypewriterText speed={10}>Hyperion explorer custom UI:</TypewriterText></p>
                ...
                <br></br>
                <p className='x'><TypewriterText speed={10}>Tools for generation and cataloging of datasets:</TypewriterText></p>
